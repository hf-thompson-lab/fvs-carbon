...
create_graph() |>
  ...
  # FFE-FVS - Fire and Fuels Extension computes carbon
  add_node(
    label = "FFE-FVS",
    type = "process",
    node_data = node_data(provider = "FVS")
  ...
  add_edge(from = "FFE-FVS", to = "FFE 0-Year\nCarbon") |>
  add_node(
    label = "FFE 20-Year\nCarbon",
    type = "data",
    node_data = node_data(provider="FVS")
  ) |>
  add_edge(from = "FFE-FVS", to = "FFE 20-Year\nCarbon") |>
  ...
  add_edge(from = "FFE-FVS", to = "Jenkins 0-Year\nCarbon") |>
  add_node(
    label = "Jenkins 20-Year\nCarbon",
    type = "data",
    node_data = node_data(provider="FVS")
  ) |>
  add_edge(from = "FFE-FVS", to = "Jenkins 20-Year\nCarbon") |>
