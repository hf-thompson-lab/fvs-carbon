...
as SQLite_FIADB_ENTIRE.db. The database ships with most indexes missing, which
makes most queries very slow.
...
Create indexes on primary and foreign keys to facilitate joins.
...
Many tables have the three columns that uniquely locate a plot:
STATECD, COUNTYCD, PLOT
Index those beccause we often want to look up all the records pertaining to
a plot by location.
