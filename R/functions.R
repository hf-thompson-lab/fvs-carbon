...
hectare_at <- function(lat, lon) {
  ...
  a <- st_sfc(st_point(center) + c( approx_offset, 0), crs = crs)
  b <- st_sfc(st_point(center) + c(-approx_offset, 0), crs = crs)
  ...
  c <- st_sfc(st_point(center) + c(0,  approx_offset), crs = crs)
  d <- st_sfc(st_point(center) + c(0, -approx_offset), crs = crs)
