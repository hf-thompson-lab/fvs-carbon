...
x <- starting_trees |>
  ...
  mutate(DIA_ERR = abs(FRST_DIA - DIA_EST)) |>
...
ggplot(
    x,
    aes(ANN_DIA_ERR, fct_rev(fct_infreq(SPGRP_NAME)))
  ) +
...
# scale_x_discrete(guide = guide_axis(n.dodge = 2)) +
  ...
  ggtitle("Annual error in back-projected diameter") +
  xlab(bquote("Error " ~(cm %*% year^{-1}))) +
  ylab("Species Group")
