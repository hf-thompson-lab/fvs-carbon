...
For this, we need the `FIADB Reference Table CSV Archive`.
Download and unzip that into data/raw/FIADB_REFERENCE/
then run `load-sqlite-fiadb-reference.sh` to create a SQLite3
database from the CSV files.
...
fia_ref <- DBI::dbConnect(RSQLite::SQLite(), 'data/raw/SQLite_FIADB_REFERENCE.db')
