...
fvs_stand_projected_ffe <- read_csv(
    "data/fvs/FVS_NKByPlotYearly_NONE_Carbon.csv",
...
for (measyear in measyears)
  fname <- paste0("data/fvs/FVS_NK_", sprintf("%04d", measyear), "_Summary2_East.csv")
...
FVS_NoManagement_ByPlotYearly_Summary2 <-
  read_csv("data/fvs/FVS_NKByPlotYearly_NONE_Summary2_East.csv", 
    col_types = cols(StandID = col_character()))
