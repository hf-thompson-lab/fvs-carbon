...
projected_carbon <- read_csv(
  ...
  semi_join(FIA_Measured, by = join_by(STAND_ID, Year))
...
ggplot(
    data = projected_carbon |>
      union_all(FIA_Measured |> select(STAND_ID, Year, Variable, Aboveground_Live)),
...
projection_error <- projected_carbon |>
  ...
  full_join(FIA_Measured, by = join_by(STAND_ID, Year)) |>
...
ffe_jenkins <- FIA_Measured |>
  ...
  full_join(FIA_Measured_Jenkins, by = join_by(STAND_ID, Year)) |>
