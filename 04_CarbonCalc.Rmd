...
nk_to_fvs <- read_csv(
    "data/intermediate/nk_to_fvs.csv",
    col_types = cols(
      `FIA plot code` = col_character(),
...
for (measyear in measyears)
  fname <- paste0("data/fvs/Grow_", sprintf("%04d", measyear), "_FVS_Carbon.csv")
...
fvs_stand_projected_ffe <- read_csv(
    "data/fvs/NoManagement_Carbon_ByPlotYearly.csv",
...
for (measyear in measyears)
  fname <- paste0("data/fvs/Grow_", sprintf("%04d", measyear), "_FVS_Summary2_East.csv")
...
FVS_NoManagement_ByPlotYearly_Summary2 <-
  read_csv("data/fvs/NoManagement_ByPlotYearly_Summary2.csv", 
    col_types = cols(StandID = col_character()))
