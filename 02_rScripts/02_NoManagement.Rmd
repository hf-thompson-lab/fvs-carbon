...
invyr2 <- invyr1 |>
  ...
  ungroup() |>
  right_join(invyr1, by=join_by(STATECD, UNITCD, COUNTYCD, PLOT))
...
invyr3 <- invyr2 |>
  ...
  ungroup() |>
  right_join(invyr2, by=join_by(STATECD, UNITCD, COUNTYCD, PLOT))
...
invyr4 <- invyr3 |>
  ...
  ungroup() |>
  right_join(invyr3, by=join_by(STATECD, UNITCD, COUNTYCD, PLOT))
