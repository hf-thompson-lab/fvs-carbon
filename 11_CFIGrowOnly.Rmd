...
cfigro_bai_task$select(
   cfigro_bai_task$feature_names[cfigro_bai_task$feature_names != "Carbon_Flux_Residual"]
)
...
It selected the two projected quantities, and two of the three species selectors, and LAT.

## Hyperparameters

```{r optimize hyperparameters, eval = FALSE}
cfigro_bai_task$select(c(
  "Acer_rubrum", "LAT", "Projected_BA", "Projected_Tph", "Quercus_rubra"
))
...
So, that's kind of all over the map. The last result seems representative:
   importance     max.depth min.node.size          mtry     num.trees 
   "impurity"          "28"          "11"           "2"          "70" 
