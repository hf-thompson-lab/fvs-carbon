...
# it out again
grep "ThinQFA" data/fvs/FVS_CFICarbonOffsetProgram_HVST/*R43517.key | wc -l
```

> 1512

```{bash, eval = FALSE}
grep "DELETED OR CANCELED" data/fvs/FVS_CFICarbonOffsetProgram_HVST/*R43517.out | grep THINQFA | wc -l
```
> 832
