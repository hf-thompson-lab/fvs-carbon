...
compare_ffe <- fvs_stand_measured_ffe |>
  ...
  mutate(`Years Projected` = Year - first_measure_year)
...
ggplot(
  ...
  geom_point(
    size = 2,
    mapping = aes(x = Measured, y = Projected, color = `Years Projected`, shape = `Forest Type`)
  ) +
