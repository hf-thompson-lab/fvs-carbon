...
For each ingrown tree, we pick the best estimate of growth rate based on
other trees on the plot, after filtering out growth outliers:

1. The mean growth rate of at least 3 dominant trees of the same species during the inventory;
2. The mean growth rate of at least 3 trees of any dominance of the same species during the inventory;
3. The mean growth rate of at least 3 trees of any dominance of the same species group during the inventory;
4. The mean growth rate of at least 3 trees of any dominance of the same species group on the plot during any inventory.
...
prev_measyear_mixin <- tree_growth |>
  distinct(STATECD, COUNTYCD, PLOT, MEASYEAR, PREV_MEASYEAR)
...
# need to walk back by PREV_MEASYEAR
prev_measyears <- tree_ingrown_three |>
  distinct(STATECD, COUNTYCD, PLOT, PREV_MEASYEAR) |>
