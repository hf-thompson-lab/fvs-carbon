...
FVS wants mortality as a percent, so mortality % is TPAMORT at t+1
over TPA at t.

Note that no seedling mortality is noted; we can get an apprximation
of seedling mortality by looking at the delta in number of seedlings
(less the number of new saplings).
