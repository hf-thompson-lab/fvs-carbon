...
ggplot(
  ...
  xlab(bquote("Measured Annual Carbon Flux" ~(`Mg C` %.% ha^-1 %.% year^-1))) +
  ylab(bquote("Projected Annual Carbon Flux" ~(`Mg C` %.% ha^-1 %.% year^-1))) #+
...
ggplot(
  ...
  xlab("Projection Years") +
  ylab(bquote("Carbon Flux Residual" ~(`Mg C` %.% ha^-1 %.% year^-1)))
```
...
ggplot(
  ...
  ylab(bquote("BA Residual " ~(m^2 %.% ha^-1 %.% year^-1))) +
