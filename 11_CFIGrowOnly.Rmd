...
FOREST_TYPE - we will use wo-v9-3_sep2023_fg_nfi_natl.pdf

> FOREST INVENTORY AND ANALYSIS
> NATIONAL CORE FIELD GUIDE
> FOR THE NATIONWIDE FOREST INVENTORY
> Version 9.3
...
tmp_obs |>
  rename(
    ...
    `FIA Observed` = BAI_Srvy,
    `Corrected` = BAI_Adj
  ) |>
  pivot_longer(c("FVS Projected", "FIA Observed", "Corrected")) |>
