...
for (measyear in measyears)
  fname <- paste0("data/fvs/FVS_NK_", sprintf("%04d", measyear), "_Carbon.csv")
...
for (measyear in measyears)
  fname <- paste0("data/fvs/FVS_NK", sprintf("%04d", measyear), "_NONE_Summary2_East.csv")
