...
table4_rot$Clearcut <-
  round(conv_unit(table4_rot$Clearcut, 'acre', 'hectare'))
table4_rot$Shelterwood <-
  round(conv_unit(table4_rot$Shelterwood, 'acre', 'hectare'))
table4_rot$`ITS_Low Retention` <-
  round(conv_unit(table4_rot$`ITS_Low Retention`, 'acre', 'hectare'))
table4_rot$`ITS_High Retention` <-
  round(conv_unit(table4_rot$`ITS_High Retention`, 'acre', 'hectare'))
table4_rot$Background <-
  round(conv_unit(table4_rot$Background, 'acre', 'hectare'))
...
NoManagement_Carbon_ByPlot <- read_csv(
    "data/fvs/FVS_NKByPlot_NONE_Carbon.csv",
    col_types = cols(
...
write_csv(NoManagement_Carbon_ByPlot_ByYear, "data/output/FVS_NKByPlot_ByYear_NONE_Carbon.csv")
