...
In addition to scenario-specific regeneration, NK 2.4
states, "Background regenration rates (intermediate to shade tolerant species
only), input at 10 year intervals, emulated natural regeneration within stands,
independent of forest management activities."
...
fvs_species_codes <-
  ...
  select("Scientific Name", "Species Code")
...
table4_rot$Clearcut <- table4_rot$Clearcut * hectare_to_acre
table4_rot$Shelterwood <- table4_rot$Shelterwood * hectare_to_acre
table4_rot$`ITS_Low Retention` <- table4_rot$`ITS_Low Retention` * hectare_to_acre
table4_rot$`ITS_High Retention` <- table4_rot$`ITS_High Retention` * hectare_to_acre
table4_rot$Background <- table4_rot$Background * hectare_to_acre





knitr::kable(table4_rot)
```
