...
calb_vs_none <- none_carbon_tmp |>
  ...
  mutate(
    ...
    Carbon_Flux_Residual = Carbon_Flux_Calb - Carbon_Flux_None
  )
```
...
calb_vs_none |>
  filter(!is.na(Carbon_Flux_Residual)) |>
...
calb_vs_none |>
  ...
  ggtitle("Carbon Flux Residual vs. Stand Starting Basal Area (5-Year Calibration)") +
  #labs(caption = "With 5-year calibration") +
